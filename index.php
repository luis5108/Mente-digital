...
<body>
  ...
  <main>
      ...
      <section id="latest-phones" class="section-padding">
          ...
          <div class="container">
              <?php
              // Mostrar los últimos 3 celulares del array de datos
              $latest_phones = array_slice($celulares_data, -3); // Obtiene los últimos 3 elementos
              foreach ($latest_phones as $celular) {
                  ...
                  echo '    </div>';
                  echo '    <a href="catalogo.php" class="btn-secondary">Ver Detalles</a>';
                  echo '</div>';
              }
              ?>
          </div>
